...
#This script reads through "Bloom_etal_2018_Reduced_Dataset.csv" and prints out the taxon name, the diadromous status, and the total log body size for all the lines in the file. 
